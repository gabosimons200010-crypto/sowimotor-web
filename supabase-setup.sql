...
insert into bikes (id, name, brand, type, year, km, price, cc, cv, license, tag, color, created_at) values
  ('z900',  'Kawasaki Z900',      'Kawasaki',   'Naked',   2021, 12400, 7490,  948,  125, 'A2', 'Recién entrada',  'Verde lima',      now() + interval '0 second'),
  ('mt07',  'Yamaha MT-07',       'Yamaha',     'Naked',   2020, 18200, 5950,  689,  73,  'A2', null,              'Negro mate',      now() + interval '1 second'),
  ('cb650', 'Honda CB650R',       'Honda',      'Naked',   2022, 6800,  8200,  649,  95,  'A',  'Garantía 12m',    'Rojo grand prix', now() + interval '2 second'),
  ('monst', 'Ducati Monster',     'Ducati',     'Naked',   2019, 22500, 9150,  821,  109, 'A',  null,              'Rojo Ducati',     now() + interval '3 second'),
  ('pcx',   'Honda PCX 125',      'Honda',      'Scooter', 2021, 9100,  2890,  125,  12,  'A1', 'A1',              'Plata',           now() + interval '4 second'),
  ('xsr7',  'Yamaha XSR 700',     'Yamaha',     'Custom',  2020, 14300, 6200,  689,  73,  'A2', 'Top ventas',      'Forest green',    now() + interval '5 second'),
  ('gs',    'BMW R 1250 GS',      'BMW',        'Trail',   2019, 28000, 14500, 1254, 136, 'A',  null,              'Triple negro',    now() + interval '6 second'),
  ('duke',  'KTM Duke 390',       'KTM',        'Naked',   2022, 4500,  4890,  373,  44,  'A2', 'A2',              'Naranja KTM',     now() + interval '7 second'),
  ('gsxs',  'Suzuki GSX-S 750',   'Suzuki',     'Sport',   2018, 31000, 5490,  749,  114, 'A',  null,              'Azul',            now() + interval '8 second'),
  ('tmax',  'Yamaha TMAX 530',    'Yamaha',     'Scooter', 2019, 26000, 7290,  530,  46,  'A2', null,              'Negro',           now() + interval '9 second'),
