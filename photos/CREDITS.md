...
**Estas fotos son de relleno para la demo. Sustitúyelas por las fotos reales
...
| Archivo | Fuente | Licencia | Original |
|---|---|---|---|
...
| `gsxs.jpg` | Unsplash | Unsplash License (uso comercial, sin atribución obligatoria) |  |
| `tmax.jpg` | Wikimedia Commons | Public domain | Yamaha Tmax 2007.jpg |
| `v7.jpg` | Wikimedia Commons | Public domain | Moto Guzzi V7 ClassicWP.jpg |
| `ninja.jpg` | Wikimedia Commons | CC0 | Moscow, Kawasaki Ninja 650 01.jpg |

## Sobre las licencias

- **Unsplash License** y **CC0 / dominio público**: sin obligación de citar.
- **CC BY**: exige citar al autor.
- **CC BY-SA**: exige citar y compartir igual. Es la más incómoda para una web
  comercial, así que conviene que estas sean las primeras en sustituirse.

Al reemplazarlas por fotos propias del local, este fichero deja de aplicar.
